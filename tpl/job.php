                ...
                <div class="container">
                   <div class="job__header">
                           ...
                           <div class="col-md">
                                <ul class="nav nav-tabs" id="pills-tab" role="tablist">
                                    <li class="nav-tabs__item">
                                        <a class="nav-tabs__tab active" id="pills-staff-tab" data-toggle="pill" href="#pills-staff" role="tab" aria-controls="pills-staff" aria-selected="true">Сотрудникам</a>
                                    </li>
                                    <li class="nav-tabs__item">
                                        <a class="nav-tabs__tab" id="pills-seekers-tab" data-toggle="pill" href="#pills-seekers" role="tab" aria-controls="pills-seekers" aria-selected="false">Соискателям</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-auto text-right">
                                <div class="job__contacts">
                                    Все вопросы - по тел. в Южно-Сахалинске: 
                                    <a class="job__tel" href="tel:390737">39 07 37</a> 
                                    <a class="job__tel" href="tel:89841390737">(8 984 139 07 37)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-staff" role="tabpanel" aria-labelledby="pills-staff-tab">
                            <div class="job__list">
                                <div class="job__item">
                                    ...
                                    <p class="job__descr">
                                        Товарищи! рамки и место обучения кадров требуют от нас анализа модели развития. С другой стороны постоянное информационно-пропагандистское обеспечение нашей деятельности требуют определения и уточнения позиций, занимаемых участниками в отношении поставленных задач. 
                                    </p>
                                    <p class="job__date">
                                        17 Декабря 2020
                                    </p>
                                ...
                                <div class="job__item">
                                    <h2 class="job__title">
                                        Инженер по наладке и испытаниям лифтового оборудования
                                    </h2>
                                    <p class="job__descr">
                                        Товарищи! рамки и место обучения кадров требуют от нас анализа модели развития. С другой стороны постоянное информационно-пропагандистское обеспечение нашей деятельности требуют определения и уточнения позиций, занимаемых участниками в отношении поставленных задач. 
                                    </p>
                        ...
                        <div class="tab-pane fade" id="pills-seekers" role="tabpanel" aria-labelledby="pills-seekers-tab">
                            <div class="job__list">
                                <div class="job__item">
                                    <h2 class="job__title">
