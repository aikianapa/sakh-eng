                            ...
                            <div class="realty-item__sidebar">
                                ...
                                <div class="realty-item__slider">
                                    <div class="realty-item__slider-for">
                                        <div class="realty-item__big-img" style="background-image: url(assets/img/country-item/1.png);"></div>
                                        <div class="realty-item__big-img" style="background-image: url(assets/img/country-item/2.png);"></div>
                                        <div class="realty-item__big-img" style="background-image: url(assets/img/country-item/3.png);"></div>
                                        <div class="realty-item__big-img" style="background-image: url(assets/img/country-item/4.png);"></div>
                                        <div class="realty-item__big-img" style="background-image: url(assets/img/country-item/5.png);"></div>
                                    </div>
                                    <div class="realty-item__slider-nav">
                                        <div class="realty-item__small-img" style="background-image: url(assets/img/country-item/1.png);"></div>
                                        <div class="realty-item__small-img" style="background-image: url(assets/img/country-item/2.png);"></div>
                                        <div class="realty-item__small-img" style="background-image: url(assets/img/country-item/3.png);"></div>
                                        <div class="realty-item__small-img" style="background-image: url(assets/img/country-item/4.png);"></div>
                                        <div class="realty-item__small-img" style="background-image: url(assets/img/country-item/5.png);"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
