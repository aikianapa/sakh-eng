                            ...
                            <ul class="sidebar__list sidebar__list--realty">
                                <li class="sidebar__item sidebar__item--realty ">
                                    ...
                                    <div class="sidebar__hidden ">
                                        <a href="residential-map.html" class="sidebar-hidden__link ">
                                            На карте
                                        </a>
                                ...
                                <li class="sidebar__item sidebar__item--realty sidebar__item--active">
                                    ...
                                    <div class="sidebar__hidden sidebar__hidden--active">
                                        ...
                                        <a href="commercial-rent.html" class="sidebar-hidden__link sidebar__hidden--underline">
                                            Аренда
                                        </a>
                                    </div>
                                </li>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="projects">
                            <div class="projects__list">
                                <a href="commercial-item-1-rent.html" class="projects__item">
                                    ...
                                    <img src="assets/img/commercial/commercial_1.png" alt="жилой комплекс" class="projects__img">
                                </a>
                                <a href="#" class="projects__item">
                                    ...
                                    <img src="assets/img/commercial/commercial_2.png" alt="жилой комплекс" class="projects__img">
                                </a>
                                <a href="#" class="projects__item">
                                    <div class="projects__name">
                                        Венера
                                    ...
                                    <img src="assets/img/commercial/commercial_3.png" alt="жилой комплекс" class="projects__img">
                                </a>
                                <a href="#" class="projects__item">
                                    <div class="projects__name">
                                        Модерн
                                    ...
                                    <img src="assets/img/commercial/commercial_4.png" alt="жилой комплекс" class="projects__img">
                                </a>
                            </div>
                        </div>
                    </div>
